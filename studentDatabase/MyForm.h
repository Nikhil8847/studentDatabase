...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// txtScore2
			// 
			this->txtScore2->AccessibleName = L"txtScore2";
			...
			this->txtScore1->TextChanged += gcnew System::EventHandler(this, &MyForm::txtScore1_TextChanged);
			...
			this->txtFaculty->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 18, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->txtFaculty->Location = System::Drawing::Point(322, 129);
...
#pragma endregion
	...
	private: System::Void txtScore1_TextChanged(System::Object^ sender, System::EventArgs^ e) {
	}
private: System::Void btnReset_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	cboCourseMedium->Text = "";
	cboDifficultyLevel->Text = "";

	cboDayScholar->Text = "No";
	cboOtherState->Text = "No";
	cboOverseas->Text = "No";
...
private: System::Void btnResult_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	try
	{
		...
		Unit[8] = (Unit[0] + Unit[1] + Unit[2] + Unit[3] + Unit[4] + Unit[4] + Unit[5] + Unit[6] + Unit[7]);
		if (Unit[8] <= 800)
